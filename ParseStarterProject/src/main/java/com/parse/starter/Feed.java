            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null) {
                    ...
                    if(objects.size()>0){
                        ...
                        SimpleAdapter simpleAdapter = new SimpleAdapter(Feed.this, tweetData, android.R.layout.simple_list_item_2, new String[]{"username", "content"}, new int[]{android.R.id.text1, android.R.id.text2});
